/*function onLoaded() {
    ...
    var extScript = "$._ext_PHXS.initialize()";
...
function loadJSX() {
    ...
    //alert("extensionRoot: "+extensionRoot);
    csInterface.evalScript('$._ext.evalFiles("' + extensionRoot + '")');
    //alert("afterExtensionRoot: "+extensionRoot);
}
...
function onClickButton(url, digest, id) {
	...
	var extScript = "$._ext_PHXS.run('"+object+"')";
	evalScript(extScript);
}

function uploadAsset(object) {
	var extScript = "$._ext_PHXS.upload('"+object+"')";
	evalScript(extScript);
}