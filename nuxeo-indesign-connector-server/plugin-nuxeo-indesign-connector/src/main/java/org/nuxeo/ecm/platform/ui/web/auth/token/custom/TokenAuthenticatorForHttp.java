 ...
 *     Antoine Taillefer
 */
package org.nuxeo.ecm.platform.ui.web.auth.token.custom;
 ...
 * @since 5.7
 */
public class TokenAuthenticatorForHttp implements NuxeoAuthenticationPlugin {
    ...
    private static final Log log = LogFactory.getLog(TokenAuthenticatorForHttp.class);
