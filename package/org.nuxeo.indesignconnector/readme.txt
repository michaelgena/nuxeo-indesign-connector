...
Step 1 :
Copy the folder org.nuxeo.indesignconnector :
...
Copy the 2 files present in the script folder (EnableUnsignedExtensions.jsx and DisableUnsignedExtensions.jsx) into the "Scripts Panel" folder
